...
async def cmd_start(message: types.Message):
    ...
    welcome_text = (
        ...
        "**Core Skills:**\n"
        "💡 Tag ideas with `#idea` to log them to the vault.\n"
        "🎙 Send voice messages for automatic transcription (coming soon).\n"
        "📊 Get a `/weekly` summary of your thoughts (coming soon).\n\n"
